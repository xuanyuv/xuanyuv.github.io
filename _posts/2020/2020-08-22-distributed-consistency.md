...
> Google Chubby 的作者 Mike Burrows 说过：这个世界上只有一种一致性算法，那就是 Paxos，其它的算法都是残次品
...
即只有 leader 才能发起提案，follower 来参与投票，observer 则被动接受（这里 leader 存在单点故障，所以又提供了 leader 选举机制）
