...
　　　　　像微信/QQ这种群消息，每个人看到的消息序列不同，也没多大问题（技术上可以做到，业务上未必必需）
...
* Scale out：有效（即水平扩展：一台机器不行，那就集群。想跟别人拼算力，往往都是通过这种方式提升本地算力）
...
　　　　　那么该区块所属人就可以收取一笔交易费用，比如 0.5 比特币，这些比特币是交易比特币的人给矿工的
...
如果两个节点同时挖到矿，那就可能出现区块链的分叉

也就是说，两个人同时挖到矿后，都把自己挖到的节点，链到本地的区块链上，这就出现了区块链分叉

这只是局部的节点会以为自己在最新的链上挖到了矿，并且会将自己挖到矿的信息传播给自己附近的区块链节点

以便于其它的节点先同步完最新的数据，再在最新的数据基础之上继续挖矿

（大家在自己以为最新的节点上，继续挖矿）

![](https://cdn.jsdelivr.net/gh/jadyer/mydata/img/blog/2022/2022-08-10-blockchain-bitcoin-03.png)
...
虽然，理论上任何人都可以修改程序，升级版本，就看有没有人陪你玩罢了

如果你挖到的矿大家不认可，那就纯属浪费电

**还是那句话，在区块链的世界里，遵守规则才能让矿工的利益最大化**

分叉的总结：
1. 区块链分叉，本质是一个“高可用存储，数据一致性”的问题（临时出现了数据不一致，但最终会达成数据一致）
2. 探测到分叉时，会以更长的链为准
