...
　　　　　像微信/QQ这种群消息，每个人看到的消息序列不同，也没多大问题（技术可以做到，业务未必必需）
...
* Scale out：有效（即水平扩展：一台机器不行，就集群。想跟别人拼算力，往往都是通过这种方式提升本地算力）
...
* 统计机制：假设期望比特币全球区块链每 10 分钟生成一个区块，那么首先需要一个统计机制，比如每 2 周做一次统计<br/>
...
　　　　　相反，如果改为 47bit 哈希结果符合预期，才算挖矿成功，这样得到预期哈希的概率就变高了，挖矿就变快了<br/>
