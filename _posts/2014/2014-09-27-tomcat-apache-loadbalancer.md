...
整合细节详见：[http://jadyer.cn/2014/09/27/tomcat-apache-jk/](http://jadyer.cn/2014/09/27/tomcat-apache-jk/)
...
1. 修改端口（由于我是在一台机器上复制多个tomcat，所以需要修改端口，如果是不同的机器就可以跳过这一步）
    ...
    > ```sh
[root@CentOS64 app]# vi tomcat/conf/server.xml  # 修改8005为-1，原因详见http://jadyer.cn/2014/09/27/tomcat-telnet-shutdown/
...
*关于jkstatus的配置和使用*，详见：[http://jadyer.cn/2014/09/27/tomcat-apache-jk/#jk-1](http://jadyer.cn/2014/09/27/tomcat-apache-jk/#jk-1)
