...
/**
 * Solr系列第03节之高亮
 * Created by 玄玉<https://jadyer.github.io/> on 2013/08/20 13:50.
 */
public enum HelloSolrJHighLighter {
     ...
     * 关于指定中文分词器的具体方法，详见https://jadyer.github.io/2013/08/20/solr-search-chinese-analyzer/
     * --------------------------------------------------------------------------------------------------
     */
     ...
     * --------------------------------------------------------------------------------
     * 测试前记得启动Web服务器
     * 关于Solr与Tomcat的整合，详见https://jadyer.github.io/2013/08/20/solr-tomcat/
     * --------------------------------------------------------------------------------
     */
