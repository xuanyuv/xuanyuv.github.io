...
@WebService(targetNamespace="http://jadyer.cn/")
...
@WebService(endpointInterface="com.jadyer.service.HelloService", targetNamespace="http://jadyer.cn/")
    ...
    public boolean handleMessage(SOAPMessageContext context) {
        ...
        if(isOutBound){
            try {
                ...
                QName qname = new QName("http://jadyer.cn/", "licenseInfo", "ns");
 ...
 * 补充：wsimport用法详见http://jadyer.cn/2013/03/19/jaxws-demo-and-wsimport/
...
Payload: <soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"><soap:Header><ns:licenseInfo xmlns:ns="http://jadyer.cn/">Jadyer</ns:licenseInfo></soap:Header><soap:Body><ns2:getUserList xmlns:ns2="http://jadyer.cn/"><arg0><age>0</age><id>0</id><username>jadyer</username></arg0></ns2:getUserList></soap:Body></soap:Envelope>
--------------------------------------
...
Headers: {}
Payload: <soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"><soap:Header/><soap:Body><ns2:getUserListResponse xmlns:ns2="http://jadyer.cn/"><return><age>11</age><id>1</id><password>xuanyu</password><username>admin</username></return><return><age>22</age><id>2</id><password>hongyu</password><username>jadyer</username></return></ns2:getUserListResponse></soap:Body></soap:Envelope>
--------------------------------------
```
...
信息: Creating Service {http://jadyer.cn/}HelloServiceService from class net.csdn.blog.jadyer.HelloService
2013-5-31 22:28:59 org.apache.cxf.services.HelloServiceService.HelloServicePort.HelloService
信息: Outbound Message
---------------------------
ID: 1
