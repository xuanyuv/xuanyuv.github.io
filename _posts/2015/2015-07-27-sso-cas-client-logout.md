...
比如[http://sso.jadyer.com:8080/cas-server-web/logout?service=https://jadyer.cn/](http://sso.jadyer.com:8080/cas-server-web/logout?service=https://jadyer.cn/`)
...
function ssoLogout(){
    if(confirm('确定要退出系统吗？')){
        //top.location.href ='http://sso.jadyer.com:8080/cas-server-web/logout?service=https://jadyer.cn/';
 ...
 * Created by 玄玉<https://jadyer.cn/> on 2012/06/07 17:30.
 */
public enum ConfigUtil {
     ...
     * -------------------------------------------------------------------------
     * Created by 玄玉<https://jadyer.cn/> on 2015/02/02 17:22.
     */
