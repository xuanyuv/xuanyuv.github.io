...
比如[http://sso.xuanyuv.com:8080/cas-server-web/logout?service=https://www.xuanyuv.com/](http://sso.xuanyuv.com:8080/cas-server-web/logout?service=https://www.xuanyuv.com/`)
...
#where to logout
casServerLogoutUrl=http://sso.xuanyuv.com:8080/cas-server-web/logout
#where to login
...
#who am i
casClientServerName=http://boss.xuanyuv.com:8080
```
...
<%@ page import="com.xuanyuv.util.ConfigUtil"%>
...
function ssoLogout(){
    if(confirm('确定要退出系统吗？')){
        //top.location.href ='http://sso.xuanyuv.com:8080/cas-server-web/logout?service=https://www.xuanyuv.com/';
        //top.location.href ='http://sso.xuanyuv.com:8080/cas-server-web/logout?service=http://sso.xuanyuv.com:8080/cas-server-web/login';
 ...
 * Created by 玄玉<https://www.xuanyuv.com/> on 2012/06/07 17:30.
 */
public enum ConfigUtil {
     ...
     * -------------------------------------------------------------------------
     * Created by 玄玉<https://www.xuanyuv.com/> on 2015/02/02 17:22.
     */
