...
title: "CXF入门例子"
categories: CXF
tags: cxf xfire webservice jax-ws soa
author: 玄玉
...
@WebService(targetNamespace="https://jadyer.github.io/")
...
@WebService(endpointInterface="com.jadyer.service.HelloService", targetNamespace="https://jadyer.github.io/")
...
public class ServerApp {
    ...
    public static void main(String[] args) {
        ...
        //打印接收和响应的SOAP通信报文,这样就不用再使用tcpmon了
    ...
    public boolean handleMessage(SOAPMessageContext context) {
        ...
        if(isOutBound){
            try {
                ...
                QName qname = new QName("https://jadyer.github.io/", "licenseInfo", "ns");
 ...
 * 补充：wsimport用法见-->http://blog.csdn.net/jadyer/article/details/8692108
...
Payload: <soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"><soap:Header><ns:licenseInfo xmlns:ns="https://jadyer.github.io/">Jadyer</ns:licenseInfo></soap:Header><soap:Body><ns2:getUserList xmlns:ns2="https://jadyer.github.io/"><arg0><age>0</age><id>0</id><username>jadyer</username></arg0></ns2:getUserList></soap:Body></soap:Envelope>
--------------------------------------
...
Headers: {}
Payload: <soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"><soap:Header/><soap:Body><ns2:getUserListResponse xmlns:ns2="https://jadyer.github.io/"><return><age>11</age><id>1</id><password>xuanyu</password><username>admin</username></return><return><age>22</age><id>2</id><password>hongyu</password><username>jadyer</username></return></ns2:getUserListResponse></soap:Body></soap:Envelope>
--------------------------------------
```
...
信息: Creating Service {https://jadyer.github.io/}HelloServiceService from class net.csdn.blog.jadyer.HelloService
2013-5-31 22:28:59 org.apache.cxf.services.HelloServiceService.HelloServicePort.HelloService
信息: Outbound Message
---------------------------
ID: 1
