...
-- 查询某张表的所有列信息
SELECT COLUMN_NAME, IS_NULLABLE, DATA_TYPE, COLUMN_KEY, EXTRA, COLUMN_COMMENT, ifnull(CHARACTER_MAXIMUM_LENGTH, NUMERIC_PRECISION) as length FROM information_schema.COLUMNS WHERE TABLE_NAME='表名' ORDER BY ORDINAL_POSITION;
